...
<html>
    ...
    <body>
        <header>
            ...
            <a  href="#home" onClick="document.location.href='statistics2.php'">Statistics</a>
            <a  href="#home" onClick="document.location.href='collection.php'">Collection</a>
            <a  href="#home" onClick="document.location.href='album.php'">Albums</a>
            <a class="active" href="#about">About</a>
            <a href="#login" id="login-item" onClick="document.location.href='logoutconfirm.php'">Log Out</a>
            </div>
            </div>
        </header>
        <div class="main-bg">
